...
[h2]Internal Affairs Revolution[/h2]
...
[h2]Reformation Plan: Phase II[/h2]
...
The development version of this mod would post on [url=https://github.com/Lyther/The-Reform-Plan---Reborn]GitHub[/url]. If you want to play the latest version instead of the stable version, please follow the repo and use [code single]git pull[/code] to get the latest commit.
...
此MOD的开发版本将在[url=https://github.com/Lyther/The-Reform-Plan---Reborn]GitHub[/url]进行实时更新，如果您想游玩最新的开发版本而非稳定版本，可以通过GitHub仓库的[code single]git pull[/code]获取最新的commit。
